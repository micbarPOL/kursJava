...
public class Zdarzenia1 {
	...
	public static void main(String[] args) {
		...
		mojListener listener = new mojListener(); // tworze listenera (w oddzielnej klasie ktory bedzie cos robil
		guzik.addActionListener(listener); //dodaje action listener ktory przyjmuje Listenera
